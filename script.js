...
function verificar(){
    if(checkbox.checked){
        ...
        titulo.style.borderBottomColor = 'blue' //troca cor da borda debaixo do titulo
        ...
        titulo.style.borderBottomColor = 'rgb(43, 167, 250)' //troca cor da borda debaixo do titulo
